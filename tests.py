...
class TestBooksCollector:
    ...
    def test_set_book_genre_book_and_genre_exist_genre_set(self, collector):
    ...
    def test_set_book_genre_different_books_genre_set(self, collector, book_name, genre):
        collector.add_new_book(book_name)
        collector.set_book_genre(book_name, genre)
        assert collector.get_book_genre(book_name) == genre

    def test_get_books_with_specific_genre_returns_books_list(self, collector, filled_collector):
    ...
    def test_add_new_book_invalid_length_book_not_added(self, collector):
        collector.add_new_book('')
        assert '' not in collector.get_books_genre()

    def test_get_books_with_specific_genre_invalid_genre_empty_list(self, collector):
        collector.add_new_book('Властелин Колец')
        collector.set_book_genre('Властелин Колец', 'Фантастика')
        result = collector.get_books_with_specific_genre('Драмма')
        assert result == []

    def test_get_books_for_children_excludes_restricted_books(self, collector):
    ...
    def test_get_books_genre_returns_correct_genre_dict(self, collector):
